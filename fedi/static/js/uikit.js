...
(function (global, factory) {
    ...
    function toPx(value, property = "width", element = window, offsetDim = false) {
      ...
      return sumBy(parseCalc(value), (value2) => {
        ...
        return unit ? percent(
          unit === "vh" ? getViewportHeight() : unit === "vw" ? width(toWindow(element)) : offsetDim ? element["offset".concat(ucfirst(property))] : dimensions$1(element)[property],
          value2
        ) : value2;
      });
    }
    ...
    function swipe(options) {
      return {
        ...
        handler(e) {
          ...
          once(document, "".concat(pointerUp$1, " ").concat(pointerCancel, " scroll"), (e2) => {
    ...
    function listenForBackgroundClose$1(modal) {
      return on(document, pointerDown$1, ({ target }) => {
        ...
        once(
          document,
          "".concat(pointerUp$1, " ").concat(pointerCancel, " scroll"),
        ...
        length(length) {
          ...
          if (this.nav && length !== navLength) {
            ...
            for (let i = 0; i < length; i++) {
              append(this.nav, "<li ".concat(this.attrItem, '="').concat(i, '"><a href></a></li>'));
            }
          }
        }
      },
    ...
    var notification = {
      ...
      created() {
        ...
        let container = $(".".concat(posClass), this.container);
    ...
    var tooltip = {
      ...
      methods: {
        ...
        async _show() {
          ...
          on(this.tooltip, "toggled", (e, toggled) => {
            ...
            this.origin = this.axis === "y" ? "".concat(flipPosition(dir), "-").concat(align) : "".concat(align, "-").concat(flipPosition(dir));
            const handlers = [
              once(
                document,
                "keydown ".concat(pointerDown$1),
                this.hide,
                false,
      ...
      events: {
        focus: "show",
        blur: "hide",
        ["".concat(pointerEnter, " ").concat(pointerLeave)](e) {
          if (!isTouch(e)) {
    ...
    var Accordion = {
      ...
      update() {
        const activeItems = filter$1(this.items, ".".concat(this.clsOpen));
    ...
    var heightViewport = {
      ...
      update: {
        read() {
          ...
          if (this.expand) {
            minHeight = "".concat(viewportHeight - (dimensions$1(scrollElement).height - dimensions$1(this.$el).height) - box, "px");
          } else {
    ...
    var scrollspy = {
      ...
      watch: {
        elements(elements) {
          if (this.hidden) {
            css(filter$1(elements, ":not(.".concat(this.inViewClass, ")")), "opacity", 0);
          }
        }
      },
      connected() {
